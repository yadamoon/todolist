<template>
  ...
  <div
    class="flex items-center justify-center from-[#F9F5F3] via-[#F9F5F3] to-[#F9F5F3] bg-gradient-to-br px-2"
  >
    <div
      class="max-w-md mx-auto bg-white rounded-3xl shadow-xl overflow-hidden"
    >
